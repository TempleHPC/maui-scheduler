...
int MCredLoadConfig(
    ...
    int OIndex, char *CName, char *ABuf, char *EMsg)

{
    ...
    if ((CName == NULL) || (CName[0] == '\0')) {
        ...
        while (MCfgGetSVal(head, &ptr, MCredCfgParm[OIndex], IndexName, NULL,
            ...
            if ((MOGetComponent(C, OIndex, (void *)&CFSPtr, mxoFS) ==
                 FAILURE) ||
                (MOGetComponent(C, OIndex, (void *)&CLPtr, mxoLimits) ==
                 FAILURE)) {
        ...
        if (MCfgGetSVal(head, NULL, MCredCfgParm[OIndex], CName, NULL, Value,
        ...
        case mxoUser:
            ...
            if ((U->F.QDef == NULL) || (U->F.QDef == &MQOS[0])) {
                if ((MSched.DefaultU != NULL) &&
                    ...
                    if (Q != NULL) MUBMSet(Q->Index, U->F.QAL);
                }
            }
...
int CredInitialize(
    ...
    int OIndex, void *C, char *CName)

{
    int rc;

    if ((C == NULL) || (CName == NULL) || (CName[0] == '\0')) {
        return (FAILURE);
    }
...
int MOGetObject(
    ...
    int OIndex, char *CName, void **C, int Mode)

{
    ...
    if (CName[0] == '\0') {
        if ((OIndex == mxoUser) || (OIndex == mxoGroup) ||
            (OIndex == mxoAcct) || (OIndex == mxoPar) || (OIndex == mxoClass) ||
            (OIndex == mxoQOS)) {
...

{
    ...
    if ((Value == NULL) || (Value[0] == '\0') || (L == NULL) || (F == NULL)) {
        return (FAILURE);
    }
    ...
    while (ptr != NULL) {
        ...
        if (MUGetPair(ptr, (const char **)MCredAttr, &aindex, ArrayLine, TRUE,
        ...
        switch (aindex) {
            ...
            case mcaPriority:
                ...
                DBG(4, fFS)
                DPrint("INFO:     cred priority set to %ld\n", F->Priority);
...

            {
                ...
                __MCredParseLimit(ValLine, &tmpIS, &tmpIH);
                ...
                if (ArrayLine[0] != '\0') {
                    ...
                    if (((OType = MUStrTok(ArrayLine, ":", &TokPtr)) == NULL) ||
                        ((oindex = MUGetIndex(ArrayLine, MXOC, TRUE,
                                              mxoNONE)) == mxoNONE)) {
                        break;
                    }
                    ...
                    if ((OName = MUStrTok(NULL, ":", &TokPtr)) != NULL) {
                        ...
                        switch (oindex) {
...

                            {
                                ...
                                for (uindex = 0; uindex < MAX_MUSER + MAX_MHBUF;
                                     uindex++) {
            ...
            case mcaMaxJobPerUser:
                ...
                switch (OIndex) {
...

                    {
                        ...
                        if (L->APU == NULL)
                            L->APU = (mpu_t *)calloc(
                                1, sizeof(mpu_t) * (MAX_MUSER + MAX_MHBUF));

                        __MCredParseLimit(ValLine,
                                          &L->APU[0].SLimit[mptMaxJob][0],
                                          &L->APU[0].HLimit[mptMaxJob][0]);

                        for (uindex = 1; uindex < MAX_MUSER + MAX_MHBUF;
                             uindex++) {
                            L->APU[uindex].SLimit[mptMaxJob][0] =
                                L->APU[0].SLimit[mptMaxJob][0];
                            L->APU[uindex].HLimit[mptMaxJob][0] =
                                L->APU[0].HLimit[mptMaxJob][0];
                        } /* END for (uindex) */
            ...
            case mcaMaxNode:
                ...
                __MCredParseLimit(ValLine, &L->AP.SLimit[mptMaxNode][0],
            ...
            case mcaMaxPE:
                ...
                __MCredParseLimit(ValLine, &L->AP.SLimit[mptMaxPE][0],
            ...
            case mcaMinProc:
                ...
                __MCredParseLimit(ValLine, &L->AP.SLimit[mptMinProc][0],
            ...
            case mcaMaxProcPerUser:
                ...
                switch (OIndex) {
...

                    {
                        ...
                        for (uindex = 1; uindex < MAX_MUSER + MAX_MHBUF;
                             uindex++) {
                            L->APU[uindex].SLimit[mptMaxProc][0] =
                                L->APU[0].SLimit[mptMaxProc][0];
                            L->APU[uindex].HLimit[mptMaxProc][0] =
                                L->APU[0].HLimit[mptMaxProc][0];
                        } /* END for (uindex) */
            ...
            case mcaMaxPS:
                ...
                __MCredParseLimit(ValLine, &L->AP.SLimit[mptMaxPS][0],
            ...
            case mcaMaxWC:
                ...
                __MCredParseLimit(ValLine, &L->AP.SLimit[mptMaxWC][0],
            ...
            case mcaMaxMem:
                ...
                __MCredParseLimit(ValLine, &L->AP.SLimit[mptMaxMem][0],
            ...
            case mcaMaxIJob:
                ...
                if (L->IP != NULL) {
                    __MCredParseLimit(ValLine, &L->IP->SLimit[mptMaxJob][0],
            ...
            case mcaMaxINode:
                ...
                if (L->IP != NULL) {
                    __MCredParseLimit(ValLine, &L->IP->SLimit[mptMaxNode][0],
            ...
            case mcaMaxIPE:
                ...
                if (L->IP != NULL) {
                    __MCredParseLimit(ValLine, &L->IP->SLimit[mptMaxPE][0],
            ...
            case mcaMaxIProc:
                ...
                if (L->IP != NULL) {
                    __MCredParseLimit(ValLine, &L->IP->SLimit[mptMaxProc][0],
            ...
            case mcaMaxIPS:
                ...
                if (L->IP != NULL) {
                    __MCredParseLimit(ValLine, &L->IP->SLimit[mptMaxPS][0],
            ...
            case mcaMaxIWC:
                ...
                if (L->IP != NULL) {
                    __MCredParseLimit(ValLine, &L->IP->SLimit[mptMaxWC][0],
            ...
            case mcaMaxIMem:
                ...
                if (L->IP != NULL) {
                    __MCredParseLimit(ValLine, &L->IP->SLimit[mptMaxMem][0],
            ...
            case mcaOMaxJob:
                ...
                __MCredParseLimit(ValLine, &L->OAP->SLimit[mptMaxJob][0],
            ...
            case mcaOMaxNode:
                ...
                __MCredParseLimit(ValLine, &L->OAP->SLimit[mptMaxNode][0],
            ...
            case mcaOMaxPE:
                ...
                __MCredParseLimit(ValLine, &L->OAP->SLimit[mptMaxPE][0],
            ...
            case mcaOMaxProc:
                ...
                __MCredParseLimit(ValLine, &L->OAP->SLimit[mptMaxProc][0],
            ...
            case mcaOMaxPS:
                ...
                if (L->OAP != NULL)
                    __MCredParseLimit(ValLine, &L->OAP->SLimit[mptMaxPS][0],
                                      &L->OAP->HLimit[mptMaxPS][0]);
            ...
            case mcaOMaxWC:
                ...
                if (L->OAP != NULL)
                    __MCredParseLimit(ValLine, &L->OAP->SLimit[mptMaxWC][0],
                                      &L->OAP->HLimit[mptMaxWC][0]);
            ...
            case mcaOMaxMem:
                ...
                if (L->OAP != NULL)
                    __MCredParseLimit(ValLine, &L->OAP->SLimit[mptMaxMem][0],
                                      &L->OAP->HLimit[mptMaxMem][0]);
            ...
            case mcaOMaxIJob:
                ...
                if (L->OIP != NULL)
                    __MCredParseLimit(ValLine, &L->OIP->SLimit[mptMaxJob][0],
                                      &L->OIP->HLimit[mptMaxJob][0]);
            ...
            case mcaOMaxINode:
                ...
                if (L->OIP != NULL)
                    __MCredParseLimit(ValLine, &L->OIP->SLimit[mptMaxNode][0],
                                      &L->OIP->HLimit[mptMaxNode][0]);
            ...
            case mcaOMaxIPE:
                ...
                __MCredParseLimit(ValLine, &L->OIP->SLimit[mptMaxPE][0],
            ...
            case mcaOMaxIProc:
                ...
                __MCredParseLimit(ValLine, &L->OIP->SLimit[mptMaxProc][0],
            ...
            case mcaOMaxIPS:
                ...
                if (L->OIP != NULL)
                    __MCredParseLimit(ValLine, &L->OIP->SLimit[mptMaxPS][0],
                                      &L->OIP->HLimit[mptMaxPS][0]);
            ...
            case mcaOMaxIWC:
                ...
                if (L->OIP != NULL)
                    __MCredParseLimit(ValLine, &L->OIP->SLimit[mptMaxWC][0],
                                      &L->OIP->HLimit[mptMaxWC][0]);
            ...
            case mcaOMaxIMem:
                ...
                if (L->OIP != NULL)
                    __MCredParseLimit(ValLine, &L->OIP->SLimit[mptMaxMem][0],
                                      &L->OIP->HLimit[mptMaxMem][0]);
            ...
            case mcaOMaxJNode:
                ...
                if (L->OJP != NULL)
                    __MCredParseLimit(ValLine, &L->OJP->SLimit[mptMaxNode][0],
                                      &L->OJP->HLimit[mptMaxNode][0]);
            ...
            case mcaOMaxJPE:
                ...
                if (L->OJP != NULL)
                    __MCredParseLimit(ValLine, &L->OJP->SLimit[mptMaxPE][0],
                                      &L->OJP->HLimit[mptMaxPE][0]);
            ...
            case mcaOMaxJProc:
                ...
                if (L->OJP != NULL)
                    __MCredParseLimit(ValLine, &L->OJP->SLimit[mptMaxProc][0],
                                      &L->OJP->HLimit[mptMaxProc][0]);
            ...
            case mcaOMaxJPS:
                ...
                if (L->OJP != NULL)
                    __MCredParseLimit(ValLine, &L->OJP->SLimit[mptMaxPS][0],
                                      &L->OJP->HLimit[mptMaxPS][0]);
            ...
            case mcaOMaxJWC:
                ...
                if (L->OJP != NULL)
                    __MCredParseLimit(ValLine, &L->OJP->SLimit[mptMaxWC][0],
                                      &L->OJP->HLimit[mptMaxWC][0]);
            ...
            case mcaOMaxJMem:
                ...
                if (L->OJP != NULL)
                    __MCredParseLimit(ValLine, &L->OJP->SLimit[mptMaxMem][0],
                                      &L->OJP->HLimit[mptMaxMem][0]);
            ...
            case mcaQList:
                ...
                if (MQOSListBMFromString(ValLine, F->QAL, mAdd) == FAILURE) {
                    DBG(5, fFS)
                    DPrint("ALERT:    cannot parse string '%s' as rangelist\n",
                           ValLine);
                }

                DBG(2, fFS)
                DPrint("INFO:     QOS access list set to %s\n",
            ...
            case mcaPDef:
                ...
                DBG(4, fFS)
                DPrint("INFO:     default partition set to %s\n",
                       ((mpar_t *)F->PDef)->Name);
            ...
            case mcaPList:
                ...
                DBG(2, fFS)
                DPrint("INFO:     partition access list set to %s\n",
            ...
            case mcaJobFlags:
                ...
                for (index = 0; MJobFlags[index] != NULL; index++) {
                    if (strstr(ValLine, MJobFlags[index]) != NULL) {
                        ...
                        DBG(4, fFS)
                        DPrint("INFO:     cred flag set to %s\n",
                               MJobFlags[index]);
                    }
                } /* END for (index) */
            ...
            case mcaMaxProcPerJob:
                ...
                MCredSetAttr(O, OIndex, aindex, (void **)ValLine, mdfString,
                             mSet);
            ...
            default:
                ...
                DBG(4, fFS)
                DPrint("WARNING:  cred attribute '%s' not handled\n",
                       MCredAttr[aindex]);
...
char *MCredShowAttrs(
    ...
    mpu_t *AP, mpu_t *IP, mpu_t *OAP, mpu_t *OIP, mpu_t *OJP, mfs_t *FS,
    long Priority, long Mode)
    ...
    for (pindex = mcaPriority; pindex <= mcaJobFlags; pindex++) {
        switch (pindex) {
            case mcaPriority:
                ...
                if (Priority != 0) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%ld", MCredAttr[pindex],
                               Priority);
                }
            ...
            case mcaMaxJob:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(AP, mptMaxJob, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaMaxNode:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(AP, mptMaxNode, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaMaxPE:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(AP, mptMaxPE, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaMaxProc:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(AP, mptMaxProc, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaMaxPS:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(AP, mptMaxPS, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaMaxWC:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(AP, mptMaxWC, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaMaxMem:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(AP, mptMaxMem, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaMaxIJob:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(IP, mptMaxJob, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaMaxINode:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(IP, mptMaxNode, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaMaxIPE:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(IP, mptMaxPE, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaMaxIProc:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(IP, mptMaxProc, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaMaxIPS:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(IP, mptMaxPS, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaMaxIWC:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(IP, mptMaxWC, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaMaxIMem:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(IP, mptMaxMem, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaOMaxJob:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(OAP, mptMaxJob, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaOMaxNode:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(OAP, mptMaxNode, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaOMaxPE:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(OAP, mptMaxPE, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaOMaxProc:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(OAP, mptMaxProc, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaOMaxPS:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(OAP, mptMaxPS, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaOMaxWC:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(OAP, mptMaxWC, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaOMaxMem:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(OAP, mptMaxMem, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaOMaxIJob:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(OIP, mptMaxJob, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaOMaxINode:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(OIP, mptMaxNode, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaOMaxIPE:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(OIP, mptMaxPE, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaOMaxIProc:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(OIP, mptMaxProc, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaOMaxIPS:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(OIP, mptMaxPS, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaOMaxIWC:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(OIP, mptMaxWC, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaOMaxIMem:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(OIP, mptMaxMem, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaOMaxJNode:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(OJP, mptMaxNode, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaOMaxJPE:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(OJP, mptMaxPE, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaOMaxJProc:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(OJP, mptMaxProc, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaOMaxJPS:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(OJP, mptMaxPS, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaOMaxJWC:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(OJP, mptMaxWC, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
            ...
            case mcaOMaxJMem:
                ...
                if ((Mode & (1 << mcsLimits)) &&
                    ((ptr = __MCredShowLimit(OJP, mptMaxMem, 0, ShowUsage)) !=
                     NULL)) {
                    MUSNPrintF(&BPtr, &BSpace, " %s=%s", MCredAttr[pindex],
                               ptr);
                }
...
char *__MCredShowLimit(
    ...
    mpu_t *P, int PlIndex, int PtIndex, int ShowUsage)

{
    ...
    if (ShowUsage == TRUE) {
        sprintf(Line, "%d:", P->Usage[PlIndex][PtIndex]);
    } else {
        Line[0] = '\0';
    }
    ...
    if ((P->SLimit[PlIndex][PtIndex] == 0) ||
        ...
        sprintf(temp_str, "%d", P->HLimit[PlIndex][PtIndex]);
        strcat(Line, temp_str);
    } else {
        sprintf(temp_str, "%d,%d", P->SLimit[PlIndex][PtIndex],
...

{
    ...
    switch (AIndex) {
...

        {
            ...
            if (L->JDef == NULL) L->JDef = (void *)calloc(1, sizeof(mjob_t));
...

{
    ...
    switch (AIndex) {
        ...
        case mcaDefWCLimit:
            ...
            if ((L->JDef == NULL) || (((mjob_t *)L->JDef)->SpecWCLimit[0] == 0))
                break;
...

        {
            ...
            if (L->JMax != NULL) tmpI = ((mjob_t *)L->JMax)->Request.NC;
...

        {
            ...
            if (L->JMax != NULL) tmpI = ((mjob_t *)L->JMax)->Request.TC;
        ...
        case mcaMaxProcPerUser:
            ...
            if ((L->APU != NULL) && ((L->APU[0].HLimit[mptMaxProc][0] != 0) ||
                                     (L->APU[0].SLimit[mptMaxProc][0] != 0))) {
                sprintf(Buf, "%d,%d", L->APU[0].HLimit[mptMaxProc][0],
                        L->APU[0].SLimit[mptMaxProc][0]);
            }
        ...
        case mcaMaxNodePerUser:
            ...
            if ((L->APU != NULL) && ((L->APU[0].HLimit[mptMaxNode][0] != 0) ||
                                     (L->APU[0].SLimit[mptMaxNode][0] != 0))) {
                sprintf(Buf, "%d,%d", L->APU[0].HLimit[mptMaxNode][0],
                        L->APU[0].SLimit[mptMaxNode][0]);
            }
        ...
        case mcaMaxJobPerUser:
            ...
            if ((L->APU != NULL) && ((L->APU[0].HLimit[mptMaxJob][0] != 0) ||
                                     (L->APU[0].SLimit[mptMaxJob][0] != 0))) {
                sprintf(Buf, "%d,%d", L->APU[0].HLimit[mptMaxJob][0],
                        L->APU[0].SLimit[mptMaxJob][0]);
            }
...

{
    ...
    if (OIndex == mxoSys) {
        for (aindex = 0; aindex < E->ACount; aindex++) {
            if ((caindex = MUGetIndex(E->AName[aindex], MSysAttr, FALSE, 0)) !=
                0) {
                MSysSetAttr((msched_t *)O, caindex, (void **)E->AVal[aindex],
                            mdfString, mSet);
            }
        } /* END for (aindex) */
    } else {
        for (aindex = 0; aindex < E->ACount; aindex++) {
            ...
            MCredSetAttr(O, OIndex, caindex, (void **)E->AVal[aindex],
                         mdfString, mSet);
        } /* END for (aindex) */
    }
    ...
    switch (OIndex) {
...

        {
            ...
            for (Q = *(mqos_t **)O + 1; Q < (mqos_t *)OEnd; Q += 1) {
                if ((Q == NULL) || (Q->Name[0] == '\0')) continue;

                if ((Q->Name[0] > '\1')) {
                    *O = (void *)Q;

                    if (NameP != NULL) *NameP = Q->Name;
...
{
    int AList[] = {mcaDefWCLimit,     mcaMaxNodePerJob, mcaMaxProcPerJob,
                   mcaMaxProcPerUser, mcaMaxWCLimit,    -1};
    ...
    for (aindex = 0; AList[aindex] != -1; aindex++) {
        if ((MCredAToString(O, OIndex, AList[aindex], tmpString, 0) ==
             FAILURE) ||
            (tmpString[0] == '\0')) {
            continue;
        }

        sprintf(temp_str, " %s=%s", MCredAttr[AList[aindex]], tmpString);
        strcat(Buf, temp_str);
    } /* END for (aindex) */
...
int MOLoadPvtConfig(
    ...
    void **O,                                                 /* I */
    int OIndex, char *OName, mpsi_t *P, char *ConfigPathName) /* I (optional) */

{
    ...
    if (MSched.PvtConfigBuffer == NULL) {
        ...
        if ((MSched.PvtConfigBuffer =
                 MFULoad(ConfigPathName, 1, macmWrite, &count, &SC)) == NULL) {
            DBG(6, fCONFIG)
            DPrint("WARNING:  cannot load file '%s'\n", ConfigPathName);
    ...
    /* FORMAT:
     * [CSKEY=<X>][CSALGO=<X>][HOST=<X>][PORT=<X>][PROTOCOL=<X>][VERSION=<X>] */
    ...
    if (OIndex > mxoNONE) {
        ...
        switch (OIndex) {
            case mxoAM:
                ...
                sprintf(IndexName, "AM:%s", ((mam_t *)O)->Name);

                break;

            case mxoRM:

                sprintf(IndexName, "RM:%s", ((mrm_t *)O)->Name);
        ...
        if (MCfgGetSVal(MSched.PvtConfigBuffer, &curptr, MParam[pClientCfg],
                        IndexName, NULL, tmpLine, sizeof(tmpLine), 0,
                        NULL) == FAILURE) {
        ...
        while (ptr != NULL) {
            ...
            if (MUGetPair(ptr, (const char **)MOServAttr, &aindex, NULL, TRUE,
                          NULL, ValLine, MAX_MNAME) == FAILURE) {
                ptr = MUStrTok(NULL, " \t\n", &TokPtr);
                ...
                case mosaCSKey:
                    ...
                    switch (OIndex) {
                        case mxoRM:
                            ...
                            MRMSetAttr((mrm_t *)O, mrmaCSKey, (void **)ValLine,
                                       mdfString, 0);
                        ...
                        case mxoAM:
                            ...
                            MAMSetAttr((mam_t *)O, mamaCSKey, (void **)ValLine,
                                       mdfString, 0);
                ...
                case mosaCSAlgo:
                    ...
                    switch (OIndex) {
                        case mxoRM:
                            ...
                            MRMSetAttr((mrm_t *)O, mrmaCSAlgo, (void **)ValLine,
                                       mdfString, 0);
                        ...
                        case mxoAM:
                            ...
                            MAMSetAttr((mam_t *)O, mamaCSAlgo, (void **)ValLine,
                                       mdfString, 0);
        ...
        while (MCfgGetSVal(MSched.PvtConfigBuffer, &curptr, MParam[pClientCfg],
                           IndexName, NULL, tmpLine, sizeof(tmpLine), 0,
                           NULL) == SUCCESS) {
            ...
            if (P != NULL) {
                ...
                while (ptr != NULL) {
                    ...
                    if (MUGetPair(ptr, (const char **)MOServAttr, &aindex, NULL,
                    ...
                    switch (aindex) {
                        case mosaCSAlgo:
                            ...
                            P->CSAlgo = MUGetIndex((char *)ValLine, MCSAlgoType,
                                                   FALSE, P->CSAlgo);
                ...
                while (ptr != NULL) {
                    ...
                    switch (aindex) {
                        case mosaCSKey:
                            ...
                            MUStrCpy(C->Name, IndexName,
                                     sizeof(MClient[index].Name));
