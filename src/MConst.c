...
const char *MBool[] = {"FALSE", "TRUE", "NOTSET", NULL};

const char *MComp[] = {"NC", "<",  "<=", "==", ">=", ">", "<>",
                       "=",  "!=", "%<", "%!", "%=", NULL};

const char *MAMOCmp[] = {NONE, "lt", "le", "eq", "ge", "gt", "ne", NULL};

const char *MCKeyword[] = {NONE,  "SC=",     "ARG=", "AUTH=", "CMD=",
                           "DT=", "CLIENT=", "TS=",  "CK=",   NULL};

/* repository for char arrays */

const char *MJobNodeMatchType[] = {NONE, "EXACTNODE", "EXACTPROC", NULL};
const char *MPolicyMode[] = {"DEFAULT", "OFF",    "ON", "SOFT",
                             "HARD",    "EXEMPT", NULL};
const char *MSimQPolicy[] = {"NORMAL", "CONSTANTJOBDEPTH", "CONSTANTPSDEPTH",
                             NULL};
const char *MSimNCPolicy[] = {"NORMAL", "UNIFORM", "PARTITIONED", NULL};
const char *MBFPolicy[] = {"NONE",        "FIRSTFIT", "BESTFIT", "GREEDY",
                           "BESTTIMEFIT", "LAZY",     "PREEMPT", NULL};
...
const char *MAMChargePolicy[] = {NONE,
                                 "DEBITALLWC",
                                 "DEBITALLCPU",
                                 "DEBITALLPE",
                                 "DEBITSUCCESSFULWC",
...
const char *MRMType[] = {NONE,   "LL",  "OTHER", "PBS",    "SGE", "SSS",
                         "WIKI", "RMS", "LSF",   "NATIVE", NULL};

/* sync w/MRMFuncEnum */

const char *MRMFuncType[] = {NONE,
                             "clusterquery",
                             "cyclefinalize",
                             "jobcancel",
                             "jobcheckpoint",
...
const char *MSimFlagType[] = {NONE,       "IGNHOSTLIST", "IGNCLASS",
                              "IGNQOS",   "IGNMODE",     "IGNFEATURES",
                              "IGNFRAME", "IGNALL",      NULL};

const char *MJobPrioAccrualPolicyType[] = {NONE, "ALWAYS", "QUEUEPOLICY",
                                           "FULLPOLICY", NULL};
const char *MBFPriorityPolicyType[] = {NONE, "RANDOM", "DURATION", "HWDURATION",
                                       NULL};
const char *MResourceLimitPolicyType[] = {NONE, "ALWAYS", "EXTENDEDVIOLATION",
                                          "BLOCKEDWORKLOADONLY", NULL};
const char *MPolicyAction[] = {NONE, "CANCEL", "REQUEUE", "SUSPEND", NULL};
const char *MNodeLoadPolicyType[] = {NONE, "ADJUSTSTATE", "ADJUSTPROCS", NULL};
const char *MFSPolicyType[] = {NONE, "DEDICATEDPS", "DEDICATEDPES",
                               "UTILIZEDPS", NULL};

const char *MSRPeriodType[] = {NONE, "DAY", "WEEK", "INFINITY", NULL};

const char *MPolicyType[] = {NONE,    "MAXJOB", "MAXNODE", "MAXPE", "MAXPROC",
                             "MAXPS", "MAXWC",  "MAXMEM",  NULL};

const char *MResSelType[] = {"NONE", "NORMAL", "BESTEFFORT", "FORCE", NULL};

const char *MGridCtlCmds[] = {NONE,     "initialize", "commit",   "list",
                              "set",    "remove",     "query",    "submit",
                              "modify", "reset",      "register", NULL};

const char *MJobCtlCmds[] = {NONE,        "cancel", "checkpoint", "diagnose",
                             "modify",    "query",  "requeue",    "resume",
                             "show",      "start",  "submit",     "suspend",
                             "terminate", NULL};

const char *MResCtlCmds[] = {NONE, "cancel", "create", "modify", "query", NULL};

const char *MBalCmds[] = {NONE, "execute", "query", NULL};

const char *MClientMode[] = {
    "NONE",   "RELATIVE", "SUMMARY", "GREP",     "VERBOSE", "FORCE", "PARSE",
    "FORCE2", "COMPLETE", "BLOCK",   "NONBLOCK", "OVERLAP", "CLEAR", NULL};

const char *MQALType[] = {"", "&", "^", NULL};

const char *MCDisplayType[] = {"NONE", "NODECENTRIC", NULL};

const char *MResFlags[] = {NONE,
                           "STANDINGRES",
                           "SINGLEUSE",
                           "BYNAME",
                           "META",
...
const char *MJRType[] = {"NONE",     "ActiveJob", "Priority", "QOSReserved",
                         "Deadline", "Meta",      "User",     NULL};

const char *MResType[] = {"NONE", "Job", "User", "Meta", NULL};

const char *MNAccessPolicy[] = {NONE,         "SHARED",     "SINGLEJOB",
                                "SINGLETASK", "SINGLEUSER", NULL};

/* NOTE: sync w/ MAX_MATTR, enum MExpAttrEnum */

const char *MAttrType[] = {
    "Feature",   "Partition", "QOS",     "Class", "Network",  "Opsys", "Arch",
    "NodeState", "JobState",  "SysAttr", "GRes",  "JFeature", NULL};

const char *MResSetSelectionType[] = {NONE, "ONEOF", "ANYOF", "FIRSTOF", NULL};

const char *MResSetAttrType[] = {NONE, "FEATURE", "MEMORY", "PROCSPEED", NULL};

const char *MResSetPrioType[] = {NONE,           "BESTFIT", "WORSTFIT",
                                 "BESTRESOURCE", "MINLOSS", NULL};

const char *BNFCommand[] = {NONE, "query", "status", "message", "set", NULL};

const char *MNodeAttr[] = {NONE,
                           "ACCESS",
                           "ARCH",
                           "GRES",
                           "AVLCLASS",
...
const char *MNPComp[] = {
    NONE,       "ADISK",       "AMEM",  "APROCS",   "ASWAP", "CDISK",
    "CMEM",     "CPROCS",      "CSWAP", "JOBCOUNT", "LOAD",  "PREF",
    "PRIORITY", "RESAFFINITY", "SPEED", "USAGE",    NULL};

const char *MAMAttr[] = {NONE,
                         "APPENDMACHINENAME",
                         "CHARGEPOLICY",
                         "CONFIGFILE",
                         "CSALGO",
...
const char *MJFActionType[] = {NONE, "CANCEL", "DEFER", NULL};

const char *MAMFuncType[] = {NONE,
                             "joballocreserve",
                             "joballocdebit",
                             "resallocreserve",
                             "resallocdebit",
...
const char *MRMAttr[] = {
    NONE,         "AUTHTYPE", "ASYNCJOBSTART", "CONFIGFILE",  "CSALGO",
    "CSKEY",      "EPORT",    "HOST",          "LOCALDISKFS", "MINETIME",
    "NAME",       "NMPORT",   "NMSERVER",      "PORT",        "SOCKETPROTOCOL",
    "SUSPENDSIG", "TIMEOUT",  "TYPE",          "VERSION",     "WIREPROTOCOL",
    NULL};

const char *MCredAttr[] = {NONE,
                           "PRIORITY",
                           "MAXJOB",
                           "MAXNODE",
                           "MAXPE",
...
const char *MOServAttr[] = {NONE,   "CSALGO",    "CSKEY",   "HOST",
                            "PORT", "SPROTOCOL", "VERSION", NULL};
...
const char *MQOSAttr[] = {NONE,       "PRIORITY", "MAXJOB",   "MAXPROC",
                          "MAXNODE",  "XFWEIGHT", "QTWEIGHT", "XFTARGET",
                          "QTTARGET", "QFLAGS",   "FSTARGET", NULL};

const char *MClassAttr[] = {NONE,
                            "OCNODE",
                            "DEFAULT.FEATURES",
                            "HOSTLIST",
                            "NAME",
...
const char *MGroupAttr[] = {NONE, "CLASSWEIGHT", NULL};

const char *MUserAttr[] = {NONE, "MAX.WCLIMIT", NULL};
...
const char *MSchedAttr[] = {NONE,   "CPVERSION", "FBSERVER", "HOMEDIR",
                            "MODE", "NAME",      "SERVER",   NULL};

const char *MClientAttr[] = {NONE, "CSALGO", "TIMEOUT", "FLAGS", NULL};

const char *MSysAttr[] = {NONE,       "time",    "statInitTime",
                          "syncTime", "version", NULL};

const char *MFrameAttr[] = {NONE, "Index", "Name", NULL};

const char *MClusterAttr[] = {NONE, "MaxSlot", "Name", "PresentTime", NULL};
...
const char *MSResAttr[] = {
    NONE,          "ACCESS",      "ACCOUNTLIST", "CHARGEACCOUNT",
    "CLASSLIST",   "DAYS",        "DEPTH",       "ENDTIME",
    "FLAGS",       "GROUPLIST",   "HOSTLIST",    "IDLETIME",
    "JOBATTRLIST", "MAXTIME",     "NAME",        "NODEFEATURES",
    "OWNER",       "PARTITION",   "PERIOD",      "PRIORITY",
    "PROCLIMIT",   "QOSLIST",     "RESOURCES",   "STARTTIME",
    "STIDLETIME",  "STTOTALTIME", "TASKCOUNT",   "TASKLIMIT",
    "TIMELIMIT",   "TPN",         "USERLIST",    "WENDTIME",
    "WSTARTTIME",  NULL};

const char *MJobAttr[] = {NONE,
                          "Account",
                          "AllocNodeList",
                          "Args",
                          "AWDuration",
...
const char *MRMXAttr[] = {
    NONE,       "ADVRES",    "DDISK",         "DISTPOLICY",
    "DMEM",     "FLAGS",     "GEOMETRY",      "HOSTLIST",
    "MFEATURE", "MMEM",      "NACCESSPOLICY", "NALLOCPOLICY",
    "NODESET",  "PARTITION", "PREF",          "QOS",
    "QUEUEJOB", "SGE",       "SID",           "SJID",
    "TPN",      "TRL",       "GRES",          NULL};

const char *MJobFlags[] = {NONE,
                           "BENCHMARK",
                           "BACKFILL",
                           "SPAN",
                           "ADVRES",
...
const char *MQOSFlags[] = {"IGNJOBPERUSER",
                           "IGNPROCPERUSER",
                           "IGNNODEPERUSER",
                           "IGNPSPERUSER",
                           "IGNJOBQUEUEDPERUSER",
...
const char *MLogFacilityType[] = {
    "fCORE", "fSCHED",  "fSOCK", "fUI",   "fLL",  "fSDR", "fCONFIG", "fSTAT",
    "fSIM",  "fSTRUCT", "fFS",   "fCKPT", "fAM",  "fRM",  "fPBS",    "fWIKI",
    "fSGE",  "fSSS",    "fLSF",  "fNAT",  "fALL", NULL};

const char *MSysNodeAttr[] = {"NONE",    "JMD",      "Batch", "Interactive",
                              "Login",   "HPSS",     "PIOFS", "System",
                              "Gateway", "EPrimary", NULL};

const char *MTLimitType[] = {NONE, "active", "idle", "system", NULL};

const char *MResThresholdType[] = {"NONE", "BYPASS", "QUEUETIME", "XFACTOR",
                                   NULL};

const char *MNAllocPolicy[] = {
    NONE,          "FIRSTAVAILABLE", "LASTAVAILABLE", "MINLOCAL", "MINGLOBAL",
    "MINRESOURCE", "PRIORITY",       "CPULOAD",       "FIRSTSET", "LOCAL",
    "CONTIGUOUS",  "MAXBALANCE",     "FASTEST",       NULL};

const char *MAllocLocalityPolicy[] = {NONE, "BESTEFFORT", "FORCED",
                                      "RMSPECIFIC", NULL};

const char *MTaskDistributionPolicy[] = {
    NONE, "DEFAULT", "LOCAL", "ARBGEO", "PACK", "ROUNDROBIN", NULL};

const char *MNAvailPolicy[] = {NONE, "COMBINED", "DEDICATED", "UTILIZED", NULL};

const char *BFWindowTraversal[] = {NONE, "LONGESTFIRST", "WIDESTFIRST", NULL};

const char *MBFMPolicy[] = {NONE,          "PROCS",   "NODES",
                            "PROCSECONDS", "SECONDS", NULL};

const char *MJSPolicy[] = {"MINPROC", "MAXPROC", "NDMAXPROC", NULL};
const char *MResPolicy[] = {"DEFAULT", "HIGHEST", "CURRENTHIGHEST", "NEVER"};
const char *MHoldType[] = {NONE,    "User", "System", "Batch",
                           "Defer", "All",  NULL};
const char *MComType[] = {"ROUNDROBIN", "BROADCAST", "TREE", "MASTERSLAVE",
                          NULL};

const char *MDefReason[] = {"NONE",
                            "Admin",
                            "NoResources",
...
const char *MCPType[] = {"Sched",  "JOB",    "RESERVATION", "SRES",  "NODE",
                         "USER",   "GROUP",  "ACCOUNT",     "TOTAL", "RTOTAL",
                         "CTOTAL", "GTOTAL", "SYSSTATS",    "RM",    "AM",
                         "Sys",    NULL};

const char *MStatType[] = {
    "AVGXFACTOR", "MAXXFACTOR",    "AVGQTIME",     "AVGBYPASS",  "MAXBYPASS",
    "JOBCOUNT",   "PHREQUEST",     "PHRUN",        "WCACCURACY", "BFCOUNT",
    "BFPHRUN",    "JOBEFFICIENCY", "QOSDELIVERED", NULL};

const char *MLLJobState[] = {"Idle",
                             "Pending",
                             "Starting",
                             "Running",
                             "CompletePending",
...
const char *MService[] = {NONE,          "showstate",       "setspri",
...
const char *MClientCmd[] =
    {
        NONE,        "mbal",    "mdiag", /* diagnose */
        "mgridctl",  "mjobctl",          /* runjob, canceljob, setqos, sethold,
                                            releasehold, setspri, setupri */
        "mnodectl",  "mresctl",          /* setres */
...
const char *MAllocRejType[] = {"Features",
                               "Class",
                               "Partition",
                               "CPU",
                               "Memory",
...
const char *MJobDependType[] = {NONE,
                                "jobstart",
                                "jobcomplete",
...
const char *MPolicyRejection[] = {NONE,
                                  "MaxJobPerUser",
                                  "MaxProcPerUser",
                                  "MaxNodePerUser",
...
const char *FrameName[] = {"0",  "1",  "2",  "3",  "4",  "5",  "6",  "7",  "8",
...
const char *FrName[] = {
    "0",    "fr1n", "fr2n", "fr3n", "fr4n", "fr5n", "fr6n", "fr7n", "fr8n",
    "fr9n", "fr10", "fr11", "fr12", "fr13", "fr14", "fr15", "fr16", "fr17",
    "fr18", "fr19", "fr20", "fr21", "fr22", "fr23", "fr24", "fr25", "fr26",
    "fr27", "fr28", "fr29", "fr30", "fr31", "fr32", "fr33", "fr34", "fr35",
    "fr36", "fr37", "fr38", "fr39", "fr40", "fr41", "fr42", "fr43", "fr44",
    "fr45", "fr46", "fr47", "fr48", "fr49", "fr50", NULL};

const char *NodeName[] = {"00", "01", "02", "03", "04", "05", "06", "07", "08",
                          "09", "10", "11", "12", "13", "14", "15", "16", NULL};

const char *MSchedMode[] = {NONE,         "NORMAL", "PROFILE", "SIMULATION",
                            "SINGLESTEP", "TEST",   NULL};

const char *MNodeState[] = {"NONE",  "None",     "Down",    "Idle",
                            "Busy",  "Running",  "Drained", "Drain",
                            "Flush", "Reserved", "Unknown", NULL};

const char *MWCVAction[] = {NONE, "CANCEL", "PREEMPT", NULL};

const char *MTimePolicy[] = {NONE, "REAL", NULL};
...
const char *MPreemptPolicy[] = {NONE,         "REQUEUE",    "SUSPEND",
                                "CHECKPOINT", "OVERCOMMIT", NULL};

/* resctl polices */

const char *MResCtlPolicy[] = {NONE, "ADMINONLY", "ANY", NULL};

/* resource types */

/* NOTE:  sync with MResLimitResourceEnum, MResourceTypeEnum */

const char *MResourceType[] = {NONE,   "NODE", "PROC", "MEM",
                               "SWAP", "DISK", NULL};
...
const char *MAttrO[] = {"NONE",  "JOB",   "NODE",     "RES",      "USER",
                        "GROUP", "ACCT",  "PAR",      "SCHED",    "SYSTEM",
                        "CLASS", "QOS",   "JFEATURE", "DURATION", "TASK",
                        "PROC",  "FRAME", "QUEUE",    "CLUSTER",  NULL};
...
const char *MXOC[] = {NONE,    "ACCT",     "AM",    "CLASS", "CLUSTER", "CP",
                      "FRAME", "FS",       "GROUP", "JOB",   "LIMITS",  "NODE",
                      "PAR",   "PRIORITY", "QOS",   "QUEUE", "RANGE",   "REQ",
                      "RSV",   "RM",       "SCHED", "SIM",   "SRES",    "STATS",
                      "SYS",   "USER",     NULL};

const char *MHRObj[] = {"NONE",       "job",      "node",    "reservation",
                        "user",       "group",    "account", "partition",
                        "scheduler",  "system",   "class",   "QOS",
                        "jobfeature", "duration", "task",    "proc",
                        "frame",      "queue",    "cluster", NULL};

const char *MWeekDay[] = {"Sun", "Mon", "Tue", "Wed",
                          "Thu", "Fri", "Sat", NULL};
const char *MWEEKDAY[] = {"SUN", "MON", "TUE", "WED",
                          "THU", "FRI", "SAT", NULL};

const char *ResModeS[] = {"InclusiveShared", "ExclusiveShared",
                          "ExclusivePrivate", "Ignored", NULL};

const char *MCBType[] = {"RESCANCEL", "RESSTART", "RESEND", "JOBSTART",
                         "JOBEND",    "JOBSTAGE", NULL};

const char *MRMAuthType[] = {"NONE", "CHECKSUM", "PKI", "SECUREPORT", NULL};

const char *WMCommandList[] = {"NONE",
                               "SUBMITJOB",
                               "GETJOBS",
                               "GETNODES",
                               "UPDATEJOB",
...
const char *WikiNodeAttribute[] = {
    "NONE"
    "UpdateTime",
    "State", "OS", "Arch", "CacheSize", "L2CacheSize", "ConfMemory",
    "AvailMemory", "ConfSwap", "AvailSwap", "ConfLocalDisk", "AvailLocalDisk",
    "ConfProcCount", "AvailProcCount", "ConfNetworkList", "AvailNetworkList",
    "CPULoad", "MaxTasks", NULL};

const char *MWikiNodeAttr[] = {
    "NONE",    "UPDATETIME", "STATE",   "OS",        "ARCH",  "CMEMORY",
    "AMEMORY", "CSWAP",      "ASWAP",   "CDISK",     "ADISK", "CPROC",
    "APROC",   "CNET",       "ANET",    "CRES",      "ARES",  "CPULOAD",
    "CCLASS",  "ACLASS",     "FEATURE", "PARTITION", "EVENT", "CURRENTTASK",
    "MAXTASK", "SPEED",      "NAME",    NULL};

const char *MWikiJobAttr[] = {
    "NONE",         "UPDATETIME", "STATE",        "WCLIMIT",   "TASKS",
    "NODES",        "GEOMETRY",   "QUEUETIME",    "STARTDATE", "STARTTIME",
    "COMPLETETIME", "UNAME",      "GNAME",        "ACCOUNT",   "RFEATURES",
    "RNETWORK",     "DNETWORK",   "RCLASS",       "ROPSYS",    "RARCH",
    "RMEM",         "RMEMCMP",    "DMEM",         "RDISK",     "RDISKCMP",
    "DDISK",        "RSWAP",      "RSWAPCMP",     "DSWAP",     "PARTITIONMASK",
    "EXEC",         "ARGS",       "IWD",          "COMMENT",   "REJCOUNT",
    "REJMESSAGE",   "REJCODE",    "EVENT",        "TASKLIST",  "TASKPERNODE",
    "QOS",          "ENDDATE",    "DPROCS",       "HOSTLIST",  "SUSPENDTIME",
    "RESACCESS",    "NAME",       "ENV",          "INPUT",     "OUTPUT",
    "ERROR",        "FLAGS",      "SUBMITSTRING", "SUBMITRM",  NULL};

const char *WikiException[] = {"NONE", "NOREPORT", "NOPARENT", NULL};

const char *WikiStatType[] = {"NONE", "JOB", "NODE", NULL};
...
const char *MS3JobState[] = {
    "NONE",      "idle",      "starting",  "running",    "removed", "completed",
    "held",      "deferred",  "submiterr", "vacated",    "notrun",  "notqueued",
    "unknown",   "batchhold", "userhold",  "systemhold", "staging", "staged",
    "suspended", "lost",      NULL};

const char *MAMOType[] = {NONE,    "account",   "class",   "wallclock",
                          "jobid", "jobtype",   "machine", "nodetype",
                          "procs", "proccrate", "qos",     "user",
                          NULL};

const char *MSAN[] = {NONE,     "action", "args",   "flags", "name",
                      "object", "op",     "option", "value", NULL};

const char *MSON[] = {NONE,  "Body",   "Data",    "Envelope",
