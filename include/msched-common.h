...
enum MACLEnum { maclNONE = 0, maclDeny, maclXOR, maclRequired };
...
enum MTraceFlagEnum { tfNONE, tfFixCorruption };
...
enum MResourceTypeEnum { mrNONE = 0, mrNode, mrProc, mrMem, mrSwap, mrDisk };
...
enum { rmaNONE = 0, rmaCheckSum, rmaPKI, rmaSecurePort };

typedef struct { int count; } mnuml_t;
