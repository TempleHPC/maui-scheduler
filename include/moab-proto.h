...
char *MCredShowAttrs(mpu_t *, mpu_t *, mpu_t *, mpu_t *, mpu_t *, mfs_t *, long,
                     long);
...
int MResCreate(int, macl_t *, char *, unsigned long, mnalloc_t *, long, long,
               int, int, char *, mres_t **, char *, mcres_t *);
...
int MResAllocateRE(char *, int, int, mnalloc_t *, int *, long, long, char *,
                   int, mreq_t *);
...
int MAMAllocJReserve(mam_t *, mjob_t *, mbool_t, enum MHoldReasonEnum *,
                     char *);
...
int MAMAllocRReserve(mam_t *, char *, long, char *, int, int, long, char *,
                     char *, enum MHoldReasonEnum *);
...
int MNodeGetPreemptList(mjob_t *, mnalloc_t *, mnalloc_t *, mjob_t **, long,
                        int, int, int *, int *);
int MNodeSelectIdleTasks(mjob_t *, mreq_t *, mnalloc_t *, mnodelist_t, int *,
                         int *, char *,
                         int R[MAX_MREQ_PER_JOB][MAX_MREJREASON]);
int MNodeSelectPreemptTasks(mjob_t *, mnalloc_t *, mnodelist_t, int *, int *,
                            char *, int R[MAX_MREQ_PER_JOB][MAX_MREJREASON],
                            long);
...
int MReqGetFNL(mjob_t *, mreq_t *, mpar_t *, nodelist_t, nodelist_t, int *,
...
int MJobGetAMNodeList(mjob_t *, mnodelist_t, mnodelist_t, char NM[MAX_MNODE],
                      int *, int *, long);
int MJobProcessCompleted(mjob_t *);
int MJobProcessRemoved(mjob_t *);
int MJobAllocatePriority(mjob_t *, mreq_t *, mnalloc_t *, int, int *, int *,
                         char *, int, int *, mnalloc_t *A[MAX_MREQ_PER_JOB],
                         int *, int *, long);
int MJobAllocateFastest(mjob_t *, mreq_t *, mnalloc_t *, int, int *, int *,
                        char *, int, int *, mnalloc_t *A[MAX_MREQ_PER_JOB],
                        int *, int *);
int MJobAllocateBalanced(mjob_t *, mreq_t *, mnalloc_t *, int, int *, int *,
                         char *, int, int *, mnalloc_t *A[MAX_MREQ_PER_JOB],
                         int *, int *);
int MJobAllocateContiguous(mjob_t *, mreq_t *, mnalloc_t *, int, int *, int *,
                           char *, int, int *, mnalloc_t *A[MAX_MREQ_PER_JOB],
                           int *, int *);
int MJobCheckNStartTime(mjob_t *, mreq_t *, mnode_t *, long, int *, double,
                        int *, char *, long *);
int MJobGetNRange(mjob_t *, mreq_t *, mnode_t *, long, int *, long *, char *,
                  int *, char *);
int MJobGetSNRange(mjob_t *, mreq_t *, mnode_t *, mrange_t *, int, char *,
...
int MJobMkTemp(mjob_t *, mreq_t *, macl_t *, macl_t *, mnalloc_t *,
               mnalloc_t *);
int MJobCheckLimits(mjob_t *, int, mpar_t *, int, char *);
int MJobCheckDataReq(mjob_t *);
int MJobDestroy(mjob_t **);
int MJobSelectPJobList(mjob_t *, int, int, mjob_t **, mnalloc_t *, mjob_t **,
                       int *, int *, nodelist_t **);
int MJobCheckDependency(mjob_t *, enum MJobDependEnum *, char *);
int MJobSetDependency(mjob_t *, enum MJobDependEnum, char *);
int MJobSelectResourceSet(mjob_t *, mreq_t *, int, int, char **, mnalloc_t *,
                          int);
int MJobCheckNRes(mjob_t *, mnode_t *, mreq_t *, long, int *, double, int *,
                  char *, long *, int);
...
int MJobGetRange(mjob_t *, mreq_t *, mpar_t *, long, mrange_t *, mnodelist_t,
                 int *, char *, int, mrange_t *);
...
int MCfgGetDVal(char *, char **, const char *, char *, int *, double *,
                char **);
int MCfgGetSVal(char *, char **, const char *, char *, int *, char *, int, int,
                char **);
int MCfgGetSList(char *, char **, const char *, char *, int *, int, char *,
                 char **);
...
int MSRSelectNodeList(mjob_t *, sres_t *, nodelist_t, int *, long, nodelist_t,
                      unsigned long);
...
int MPolicyAdjustUsage(int *, mjob_t *, mres_t *, int, mpu_t *, int, int,
                       int *);
...
int MRMJobGetProximateMNL(mjob_t *, mrm_t *, mnodelist_t, mnodelist_t, long,
                          int, char *, int *);
...
int MRMSJobAllocateResources(mjob_t *, mreq_t *, mnalloc_t *, int, int *, int *,
                             char *, int, int *, mnalloc_t *A[MAX_MREQ_PER_JOB],
                             int *, int *);
...
int MBFGetWindow(int *, int *, nodelist_t, long *, long, mpar_t *, char *,
                 char *, char *, int, int, unsigned long, mcres_t *, char *,
                 char *, char *, char *);
...
int MAVPToXML(const char *, const char *, mamolist_t *, mamolist_t *,
              mamolist_t *, char *, char *);
...
int MLocalJobAllocateResources(mjob_t *, mreq_t *, mnalloc_t *, mulong, int,
                               int *, int *, char *, int, int *,
                               mnalloc_t *B[MAX_MREQ_PER_JOB], int *, int *);
